...
# Weights for the second transducer are based on the probability of the tuple (lemma, postag) having a certain concept
...
#
## So I need:
## 0 0 lemma concept P(lemma, tag | concept) = P(lemma, tag, concept) / P(concept)
