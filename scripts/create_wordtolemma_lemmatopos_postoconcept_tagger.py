#!/usr/bin/env python3
# Creates concept tagger trying to use all extra features for the counts
# Creates word to lemma, lemma to postag, postag to concepttag transducers
# Output lexicon has words, lemmas, postags and concepts
#
# Weights for the transducers are based on simple counts
# Provides the worst scores, probably due to expecting to be able to convert just 38 POS tags to the concepts
